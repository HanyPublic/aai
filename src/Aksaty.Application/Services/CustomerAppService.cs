...
namespace Aksaty.Application.Services
{
    public class CustomerAppService : ICustomerAppService
    {
        ...
        public async Task<PagedList<CustomerViewModel>> GetAll(GetAllCustomersViewModel getAllCustomersViewModel)
        {
            return _mapper.Map<PagedList<CustomerViewModel>>(await _customerRepository.GetAll(_mapper.Map<GetAllCustomersQuery>(getAllCustomersViewModel)));
        }
        ...
        public async Task<ValidationResult> Register(CustomerRegisterViewModel customerViewModel)
        {
        ...
        public async Task<ValidationResult> Update(CustomerSalesUpdateViewModel customerUpdateViewModel)
        {
            var updateCommand = _mapper.Map<UpdateCustomerSalesCommand>(customerUpdateViewModel);
            return await _mediator.SendCommand(updateCommand);
        }
