...
namespace Aksaty.Api.Controllers
{
    ...
    public class ProductCopyControllerProductCopyController : ApiController
    {
        private readonly IProductAppService _service;
        public ProductCopyControllerProductCopyController(IProductAppService productAppService)
        {
